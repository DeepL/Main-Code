...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent start_previous=new Intent(MainActivity.this,MainScreen.class);
    ...
    void setupViewPager(ViewPager vpager){
        ...
        adapter.addFragment(new FirstFragment(), "Attendance");
        adapter.addFragment(new SecondFragment(), "Map View");
