...
public class InventoryMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, ResultCallback {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent start_previous=new Intent(InventoryMain.this,MainScreen.class);
    ...
    public void settingsrequest(){
        ...
        GoogleApiClient googleApiClient = new GoogleApiClient.Builder(InventoryMain.this)
    ...
    void setupViewPager(ViewPager vpager){
        ...
        adapter.addFragment(new AssetsForm(),"Form");
        adapter.addFragment(new Inventory(), "Accepted");
        adapter.addFragment(new InventoryReceived(), "Pending");
